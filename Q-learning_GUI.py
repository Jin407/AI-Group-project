...
learning_rate_entry.insert(0, "0.9")
...
num_episodes_entry.insert(0, "400")

# Run button to start the training and testing
run_button = tk.Button(root, text="Run Q-Learning", command=run_q_learning)
